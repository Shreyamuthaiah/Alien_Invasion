...
class AlienInvasion:
    ...
    def _update_screen(self):
            ...
            #draw the play button if the play is inactive
    ...
    def _update_bullets(self):
         """ update position of bullets and get rid ogf old bullets"""
         #update bullet position
         self.bullets.update()

         #get rid of the bullets that are disappered
    ...
    def _update_aliens(self):
         """check if the fleet is at the edge then update the positions of the aliens in the fleet"""
